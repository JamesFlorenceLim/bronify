    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-gradient-to-br from-purple-900 to-black text-white">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <h1 className="text-4xl font-bold text-center sm:text-left">
          Welcome to LeBron's Playlist
        </h1>
        <p className="text-center sm:text-left text-lg">
          Explore the King's favorite tracks and enjoy the music that inspires greatness.
        </p>

        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-white text-black gap-2 hover:bg-gray-300 font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto"
            href="/wow"
          >
            Go to Playlist
          </a>
